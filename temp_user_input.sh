...
echo "base_kernel: $base" >> /var/lib/lkp-files/variables
echo "patches_kernel: $patches" >> /var/lib/lkp-files/variables
echo "test_bed: $runchoice" >> /var/lib/lkp-files/variables
echo "stress_type: $choice" >> /var/lib/lkp-files/variables
loc=$(cd ../ && pwd)
